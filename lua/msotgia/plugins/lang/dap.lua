...
dap.adapters.cppdbg = {
    id = "cppdbg",
    type = "executable",
    command = "/home/msotgia/.config/nvim/lua/msotgia/plugins/lang/debugger/tools/vscode-cpptools/extension/debugAdapters/bin/OpenDebugAD7",
}

local cache = require("msotgia.plugins.custom.cache")
